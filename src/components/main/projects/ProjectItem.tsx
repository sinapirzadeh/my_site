...
export default function ProjectItem() {
  ...
  return (
    <motion.div
      ...
      className="m-auto shadow-lg group cursor-pointer group mr-auto overflow-hidden relative text-gray-50 h-52 w-64 rounded-lg hover:duration-700 duration-700"
    >
