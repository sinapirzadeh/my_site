  ...
  return (
    <Container>
      <motion.div
        ...
        ref={ref}
      >
        <div className="flex-row space-y-4 max-w-md mx-auto border-2  px-5 py-4 bg-white dark:bg-gray-700 dark:text-white rounded-lg shadow-lg">
          <div className="flex">
          ...
          <div className=" grid grid-cols-6 gap-2">
            <h5 className="text-xl  col-span-6">
             ارسال نظر درباره پروزه ها، مقالات ، هرچی ...
            </h5>
            <input
            ...
            <button className="border-2 px-4 py-2 mx-auto rounded-lg bg-blue-500 text-white">
              ارسال
            </button>
          </div>
        </div>
