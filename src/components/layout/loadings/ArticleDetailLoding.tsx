export default function ArticleDetailLoding() {
  return (
    <div className=" p-4 animate-pulse md:p-6 dark:border-gray-400 text-center">
      <div className="flex items-center justify-center h-48 mb-4 bg-gray-300 rounded dark:bg-gray-400 w-2/3 mx-auto">
        <svg
          viewBox="0 0 16 20"
          fill="currentColor"
